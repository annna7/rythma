...
public class FollowUnfollowArtistCommand implements Command {
    @Override
    public void execute() {
        int artistId = Integer.parseInt(askForField("artistId"));
        NotificationService.getInstance().subscribeToArtist(artistId);
    }
    ...
    public String getCommandDescription() {
        return "Follow or unfollow an artist, given its id (toggle)";
    }
}
